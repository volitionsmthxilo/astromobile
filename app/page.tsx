...
/> */}
 ...
 <div className="w-12 h-12 rounded-xl flex items-center justify-center hover:rotate-12 transition-transform" style={{ backgroundColor: '#8FC240' + '1A' }}>
      ...
      // /note15-banneroo1.webp

             // {image:"astro note 13 max.png", name: "Astro Vibe", tag: "Bugdet Range", title: "From $20us + usage top ups"},
              {image:"astrovibe06.png", name: "Astro Vibe", tag: "Bugdet Range", title: "From $10us + usage top ups"},
              {image:"astronova001.png", name: "Astro Nova", tag: "Middle Range", title: "From $20us + usage top ups"},
              {image:"astroprime006.png", name: "Astro Prime", tag: "Top Range", title: "From $30us + usage top ups"},
            ].map((product, i) => (
    ...
    alt={product.name}
    fill
    className="object-contain group-hover:scale-101 group-hover:rotate-1 transition-all duration-500"
    loading="lazy"
  />
                </div>
